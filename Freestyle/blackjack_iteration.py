...
if gamble.upper() == "N":
    print("Why the fuck are you doin' here then?")
    print("*You get kicked out of the casino*")
...
while play_count < play_count + 1:  # This means that player can play as many hands as they please
    ...
    if money_won < 0:
        money_won = - money_won
        print(f"You lost {money_won}$ at casino, sucker.")
    elif money_won > 0:
        print(f"You won {money_won}$ at casino, but the House still wins...")
    else:
        print("You walk out of the casino empty handed. ")
